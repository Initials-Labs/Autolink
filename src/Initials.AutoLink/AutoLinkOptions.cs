namespace Initials.AutoLink;

/// <summary>
/// Configuration for the keyword auto-linker, bound from the <c>Initials:AutoLink</c> configuration section.
/// </summary>
public sealed class AutoLinkOptions
{
    public const string SectionName = "Initials:AutoLink";
