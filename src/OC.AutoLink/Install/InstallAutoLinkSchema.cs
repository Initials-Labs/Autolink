    ...
    protected override async Task MigrateAsync()
    {
        ...
        IDataType booleanDataType = (await _dataTypeService.GetByEditorAliasAsync(
            ...
            ?? throw new InvalidOperationException(
                ...
                + "OC:AutoLink:InstallSchema to false.");
        ...
        if (missing.Count > 0)
        {
            throw new InvalidOperationException(
                ...
                + "The install will be retried on the next startup. Correct OC:AutoLink:InstallOnDocumentTypes if an alias is wrong, or add the property by hand.");
        }
    }
